...
public class WorkflowService {
    ...
    public void updateWorkflowStatus(DeathRegistrationRequest deathRegistrationRequest) {
        deathRegistrationRequest.getDeathRegistrationApplications().forEach(application -> {
            ...
            if (workflow == null) {
                // Handle the case when the Workflow is not set for the DeathRegistrationApplication
                throw new CustomException("WORKFLOW_NOT_SET", "Workflow not set for DeathRegistrationApplication");
            }
